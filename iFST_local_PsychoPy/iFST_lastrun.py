...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\morenoverdu\\OneDrive - UCL\\BAS-Lab\\Github repositories\\iFST\\iFST_local_PsychoPy\\iFST_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    inst_adv = keyboard.Keyboard(deviceName='defaultKeyboard')
    ...
    block_number_text = visual.TextStim(win=win, name='block_number_text',
        ...
        languageStyle='LTR',
        depth=-2.0);
    block_adv_resp = keyboard.Keyboard(deviceName='defaultKeyboard')
    ...
    prompt_before_text = visual.TextStim(win=win, name='prompt_before_text',
        ...
        languageStyle='LTR',
        depth=-1.0);
    adv_trial = keyboard.Keyboard(deviceName='defaultKeyboard')
    ...
    seq_resp = keyboard.Keyboard(deviceName='defaultKeyboard')
    ...
    sound_incorr = sound.Sound(
        ...
        stereo=True, 
        hamming=True, 
        speaker=None,    name='sound_incorr'
    )
    ...
    thisExp.currentRoutine = exp_settings
    ...
    while continueRoutine:
        ...
        if exp_settings.forceEnded or routineForceEnded:
            break
    ...
    for thisLang_loop in lang_loop:
        ...
        # --- Run Routine "load_lg" ---
        thisExp.currentRoutine = load_lg
        ...
        while continueRoutine:
            ...
            # has the Routine been forcibly ended?
            if load_lg.forceEnded or routineForceEnded:
                break
            # has every Component finished?
            continueRoutine = False
            for thisComponent in load_lg.components:
    ...
    for thisMessages_loop in messages_loop:
        ...
        thisExp.currentRoutine = update_msg
        ...
        while continueRoutine:
            ...
            # has the Routine been forcibly ended?
            if update_msg.forceEnded or routineForceEnded:
                break
            # has every Component finished?
            continueRoutine = False
            for thisComponent in update_msg.components:
    ...
    if handedness == "left":
        conditions_file = "ifst_files/conditions_left.xlsx"
    else:
        conditions_file = "ifst_files/conditions_right.xlsx"
    ...
    thisExp.currentRoutine = demographics
    ...
    while continueRoutine:
        ...
        # has the Routine been forcibly ended?
        if demographics.forceEnded or routineForceEnded:
            break
        # has every Component finished?
        continueRoutine = False
        for thisComponent in demographics.components:
    ...
    instructions_loop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ifst_files/instructions.xlsx'), 
        seed=None, 
        isTrials=False, 
    )
    ...
    for thisBlocks_loop in blocks_loop:
        ...
        thisExp.currentRoutine = block_start
        ...
        while continueRoutine:
            ...
            # has the Routine been forcibly ended?
            if block_start.forceEnded or routineForceEnded:
                break
            # has every Component finished?
            continueRoutine = False
            for thisComponent in block_start.components:
        ...
        for thisSeq_loop in seq_loop:
            ...
            thisExp.currentRoutine = pre_trial
            ...
            while continueRoutine:
                ...
                # has the Routine been forcibly ended?
                if pre_trial.forceEnded or routineForceEnded:
                    break
                # has every Component finished?
                continueRoutine = False
                for thisComponent in pre_trial.components:
            ...
            thisExp.currentRoutine = seq_trial
            ...
            while continueRoutine:
                ...
                # has the Routine been forcibly ended?
                if seq_trial.forceEnded or routineForceEnded:
                    break
                # has every Component finished?
                continueRoutine = False
                for thisComponent in seq_trial.components:
            ...
            sound_corr.setSound('ifst_stimuli/correct_sound.wav', secs=1, hamming=True)
            sound_corr.setVolume(corr_vol, log=False)
            sound_corr.seek(0)
            sound_incorr.setSound('ifst_stimuli/incorrect_sound.wav', secs=1, hamming=True)
            ...
            while continueRoutine:
                ...
                # has the Routine been forcibly ended?
                if seq_fb.forceEnded or routineForceEnded:
                    break
                # has every Component finished?
                continueRoutine = False
                for thisComponent in seq_fb.components:
        ...
        self_assess_loop = data.TrialHandler2(
            ...
            extraInfo=expInfo, 
            originPath=-1, 
            trialList=data.importConditions('ifst_files/self_assess_questions.xlsx'), 
            seed=None, 
            isTrials=True, 
        )
        ...
        for thisSelf_assess_loop in self_assess_loop:
            ...
            thisExp.currentRoutine = self_assess
            ...
            while continueRoutine:
                ...
                # has the Routine been forcibly ended?
                if self_assess.forceEnded or routineForceEnded:
                    break
                # has every Component finished?
                continueRoutine = False
                for thisComponent in self_assess.components:
