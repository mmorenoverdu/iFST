...
## Local version (OpenSesame / PsychoPy backend)
...
# OpenSesame saves one CSV per participant in the experiment folder,
# named subject-<subject_nr>.csv (e.g., subject-1.csv).
# Place the file(s) you want to process in a 'data/' subfolder, or adjust the path below.
